  ...
  { "nvim-telescope/telescope-live-grep-args.nvim", version = "^1.0.0", },
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>fg", "<cmd>Telescope live_grep<cr>", {desc = 'Telescope: live_grep'})
      vim.keymap.set("n", "<leader>fG", ":lua require('telescope').extensions.live_grep_args.live_grep_args()<cr>", {desc = 'Telescope: live_grep_args'})
